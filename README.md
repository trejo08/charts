...
|-------|-------------|---------|-------------|
| [marble](charts/marble/) | Kubernetes deployment for [Marble](https://www.checkmarble.com) — open-source fraud detection and AML platform | 0.1.0 | 1.1.0 |
...
# OCI registry
helm install marble oci://ghcr.io/trejo08/charts/marble --version 0.1.0
```
